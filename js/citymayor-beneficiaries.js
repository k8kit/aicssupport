...
class CityMayorBeneficiaries {
    ...
    async loadBeneficiaries() {
        try {
            ...
            const response = await adminAuth.makeAuthenticatedRequest(`../api/citymayor/beneficiaries.php?${queryString}`);
            if (!response) return;
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group">
                        ...
                        onclick="cityMayorBeneficiaries.viewApplication('${beneficiary.id}')"
...
document.addEventListener('DOMContentLoaded', () => {
    cityMayorBeneficiaries = new CityMayorBeneficiaries();
});